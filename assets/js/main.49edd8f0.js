...
/* harmony default export */ const routes = ([{path:'/after-install-mint-21',component:ComponentCreator('/after-install-mint-21','5f6'),exact:true},{path:'/archive',component:ComponentCreator('/archive','966'),exact:true},{path:'/change-docker-storage-location',component:ComponentCreator('/change-docker-storage-location','cac'),exact:true},{path:'/docker-clis',component:ComponentCreator('/docker-clis','5d6'),exact:true},{path:'/git-snippets',component:ComponentCreator('/git-snippets','eda'),exact:true},{path:'/host-domain-local-net',component:ComponentCreator('/host-domain-local-net','324'),exact:true},{path:'/linux-shell-snippets',component:ComponentCreator('/linux-shell-snippets','391'),exact:true},{path:'/some-scripts',component:ComponentCreator('/some-scripts','b6b'),exact:true},{path:'/tags',component:ComponentCreator('/tags','883'),exact:true},{path:'/tags/bash',component:ComponentCreator('/tags/bash','354'),exact:true},{path:'/tags/docker',component:ComponentCreator('/tags/docker','047'),exact:true},{path:'/tags/dokku',component:ComponentCreator('/tags/dokku','3b7'),exact:true},{path:'/tags/git',component:ComponentCreator('/tags/git','4d7'),exact:true},{path:'/tags/go-lang',component:ComponentCreator('/tags/go-lang','a1a'),exact:true},{path:'/tags/jenkins',component:ComponentCreator('/tags/jenkins','c75'),exact:true},{path:'/tags/linux',component:ComponentCreator('/tags/linux','002'),exact:true},{path:'/tags/mint',component:ComponentCreator('/tags/mint','a84'),exact:true},{path:'/tags/neovim',component:ComponentCreator('/tags/neovim','74b'),exact:true},{path:'/tags/node-js',component:ComponentCreator('/tags/node-js','b71'),exact:true},{path:'/tags/powershell',component:ComponentCreator('/tags/powershell','233'),exact:true},{path:'/tags/python',component:ComponentCreator('/tags/python','b32'),exact:true},{path:'/tags/rust',component:ComponentCreator('/tags/rust','1dd'),exact:true},{path:'/tags/sh',component:ComponentCreator('/tags/sh','377'),exact:true},{path:'/use-jenkins-on-dokku',component:ComponentCreator('/use-jenkins-on-dokku','2d2'),exact:true},{path:'/docs',component:ComponentCreator('/docs','231'),routes:[{path:'/docs/',component:ComponentCreator('/docs/','a8c'),exact:true,sidebar:"tutorialSidebar"},{path:'/docs/about-it',component:ComponentCreator('/docs/about-it','695'),exact:true,sidebar:"tutorialSidebar"}]},{path:'/',component:ComponentCreator('/','7d0'),exact:true},{path:'*',component:ComponentCreator('*')}]);
