...
function CodingProblemList(_ref){let{items}=_ref;const wrapperStyle={display:'flex',flexDirection:'row',flexWrap:'wrap',alignContent:'center',alignItems:'center',justifyItems:'center'};function itemStyle(solved){return{flexShrink:1,flexBasis:'175px',marginTop:'0.75rem',marginBottom:'0.75rem',overflowWrap:'break-word',flexWrap:'wrap',whiteSpace:'break-spaces'};}function linkStyle(solved){return{color:'var(--ifm-link-color)',textDecoration:'var(--ifm-link-decoration)',background:'none',border:'1px solid transparent',cursor:'pointer',fontSize:'unset',fontWeight:solved?'100':'400',fontStyle:solved?'italic':'unset'};};return/*#__PURE__*/react.createElement("div",{className:"container"},/*#__PURE__*/react.createElement("ul",{className:"row",style:wrapperStyle},items.map((value,index)=>{var _process,_process$env,_window,_window$location;const newLocation=(((_process=process)==null?void 0:(_process$env=_process.env)==null?void 0:_process$env.SITE_URL)||((_window=window)==null?void 0:(_window$location=_window.location)==null?void 0:_window$location.origin))+value.link;return/*#__PURE__*/react.createElement("li",{style:itemStyle(value.solved)},/*#__PURE__*/react.createElement("button",{style:linkStyle(value.solved),onClick:()=>{console.debug(newLocation);location.href=newLocation;}},value.text),value.solved?/*#__PURE__*/react.createElement(react.Fragment,null,"\xA0[\xA0\u2714\xA0]"):/*#__PURE__*/react.createElement(react.Fragment,null));})));}
